...
import 'package:meteo_weather/features/song_player/screen/song_player_screen.dart';
...
abstract class CustomNavigator {
  ...
  static void pop({dynamic result}) {
    if (navigatorState.currentState!.canPop()) {
      ...
      CustomNavigator.push(Routes.homeScreen, clean: true);
    }
  }
